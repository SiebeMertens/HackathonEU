...
async function generateFeedbackAndLearningPath(feedback, learningTopics, apiKey) {
  ...
  const prompt = `You are a cybersecurity learning coach. Based on the user's assessment results and learning topics, generate personalized feedback and a learning path.

User Assessment Performance:
${feedback}

Learning Topics to Focus On:
${learningTopics.join(', ')}

REQUIREMENTS:
- Create a short, personalized and encouraging feedback summary (2-3 sentences) that acknowledges strengths and areas for improvement
- For each learning topic, provide 3-4 high-quality, accessible resources with real URLs
- Include a mix of: official documentation (NIST, ENISA, OWASP), online courses (Coursera, Udemy, edX), interactive labs (TryHackMe, HackTheBox), and authoritative blogs/articles
- Ensure all URLs are real, clickable, and currently accessible

FORMAT YOUR RESPONSE AS VALID JSON:
{
  "feedbackSummary": "Encouraging, personalized feedback addressing their performance level",
  "learningPath": [
    {
      "topic": "Specific topic name from the assessment",
      "resources": [
        { "title": "Clear resource title", "url": "https://real-working-url.com", "type": "course|documentation|lab|article" },
        { "title": "Clear resource title", "url": "https://real-working-url.com", "type": "course|documentation|lab|article" },
        { "title": "Clear resource title", "url": "https://real-working-url.com", "type": "course|documentation|lab|article" }
      ]
    }
